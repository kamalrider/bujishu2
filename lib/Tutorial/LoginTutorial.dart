import 'package:Bujishu/Register/customer_register.dart';
...
void main() => runApp(LoginTutorialApp());

class LoginTutorialApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LoginTutorialPage(),
    );
  }
}

class LoginTutorialPage extends StatefulWidget {
...
class _MyHomePageState extends State<LoginTutorialPage> {
