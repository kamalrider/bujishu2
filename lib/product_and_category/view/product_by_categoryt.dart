...
class ProductCategory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ProductCategoryHomet(),
    );
  }
}

class ProductCategoryHomet extends StatefulWidget {
  final Category value;

  ProductCategoryHomet({Key key, this.value}) : super(key: key);

  @override
  _ProductCategoryHomeState createState() => _ProductCategoryHomeState();
}

class _ProductCategoryHomeState extends State<ProductCategoryHomet> {
...
//                      ),
                      SliverGrid(
                        ...
                        delegate: SliverChildListDelegate(
                            widget.value.product.map((product){
