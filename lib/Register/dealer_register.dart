...
enum RegisterMarker { first, second, third, fourth }

void main() => runApp(RegisterDealer());
...
class RegisterDealer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: RegisterDealerHome(title: 'Flutter Login'),
    );
  }
}

class RegisterDealerHome extends StatefulWidget {
  RegisterDealerHome({Key key, this.title}) : super(key: key);
  ...
  @override
  _RegisterDealerState createState() => _RegisterDealerState();
}

class _RegisterDealerState extends State<RegisterDealerHome> {
  ...
  final TextEditingController cityOfBirthController =
      new TextEditingController();
  final TextEditingController raceOfBirthController =
      new TextEditingController();
  ...
  //spouse
  final TextEditingController spouseFullNameController =
      new TextEditingController();
  final TextEditingController spouseICController = new TextEditingController();
  final TextEditingController spouseDateOfBirth = new TextEditingController();
  final TextEditingController spouseOccupationController =
      new TextEditingController();
  final TextEditingController spouseTelOffController =
      new TextEditingController();
  final TextEditingController spouseMobileContactController =
      new TextEditingController();
  final TextEditingController spouseEmailController =
      new TextEditingController();

  //employmenthistory
  final TextEditingController nameCompanyController =
      new TextEditingController();
  final TextEditingController companyAddress1Controller =
      new TextEditingController();
  final TextEditingController companyAddress2Controller =
      new TextEditingController();
  final TextEditingController companyAddress3Controller =
      new TextEditingController();
  final TextEditingController companyPostcode = new TextEditingController();
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    keyboardType:
                                        TextInputType.numberWithOptions(),
                                    controller: raceOfBirthController,
                                    cursorColor: Colors.black,
                                    decoration: InputDecoration(
                                        border: InputBorder.none,
                                        focusedBorder: InputBorder.none,
...
//                                          top: 11,
//                                          right: 15),
                          hintText: 'Spouse\'s Full Name (as per NRIC)'),
                    ),
                  ),
                ),
              ),
...
//                                          top: 11,
//                                          right: 15),
                                  hintText: 'Spouse\'s Date of Birth'),
                            ),
                          ),
                        ),
                      ),
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              keyboardType: TextInputType.numberWithOptions(),
                              controller: spouseTelOffController,
                              cursorColor: Colors.black,
                              decoration: InputDecoration(
                                  border: InputBorder.none,
                                  focusedBorder: InputBorder.none,
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              keyboardType: TextInputType.multiline,
                              maxLines: null,
                              controller: spouseMobileContactController,
                              cursorColor: Colors.black,
                              decoration: InputDecoration(
                                  border: InputBorder.none,
                                  focusedBorder: InputBorder.none,
...
//                                          top: 11,
//                                          right: 15),
                          hintText: 'Spouse\'s Email Address'),
                    ),
                  ),
                ),
              ),
              ...
              Theme(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: ListTile(
                        title: Text('Self-Employed' , style: TextStyle(color: Colors.white, fontSize: 11),),
                    ...
                    Expanded(
                      child: ListTile(
                          title: Text('Employed' , style: TextStyle(color: Colors.white, fontSize: 11),),
                          onTap: () => setState(() => selectedRadio = 0),
                          leading: Radio(
                            value: 1,
                            groupValue: selectedRadio,
...
//                            _informationPart();
    ...
    Widget getRegisterContainer() {
      switch (numberSelected) {
        ...
        case RegisterMarker.third:
          return spouseParticular();
        case RegisterMarker.fourth:
